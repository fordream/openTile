...
import com.tistory.pflower.frontline.scene.SplashScene;
...
public class BaseActivity extends SimpleBaseGameActivity {
    ...
    public static final int FPS_LIMITS = 60;
	...
	protected void onCreateResources() {
		mFont = FontFactory.create(this.getFontManager(),
				...
				Typeface.create(Typeface.DEFAULT, Typeface.BOLD), 32, 0xffffffff);
		mFont.load();
	...
	public void onDestroyResources() throws Exception 
	{
		...
		ResourceManager.getSharedInstance().clear();
	}
	*/
